# Auditoria Claude Code → Codex — 2026-09-14 16:02
...
| property-360 | reutilizável | Markdown + scripts comuns |
...
| memória (~/.claude/projects/*/memory) | 227 projetos | context/ + handoffs/ | promoção manual, nunca cópia em massa |
